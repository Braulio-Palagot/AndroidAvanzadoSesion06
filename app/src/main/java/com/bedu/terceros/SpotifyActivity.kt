...
class SpotifyActivity : AppCompatActivity() {
    object AuthParams {
        const val CLIENT_ID = "0fd0ac8bda6741ba940203cf662b2e1e"
        const val REDIRECT_URI = "https://developer.spotify.com/dashboard"
    }

    object SpotifySampleContexts {
        const val TRACK_URI = "spotify:track:5zj8WNkBrEzlI5FKeYV4ol"
        const val ALBUM_URI = "spotify:album:3pDG0vQ5LfL2BQZJJtkbg8"
        const val ARTIST_URI = "spotify:artist:0GWCNkPi54upO9WLlwjAHd"
        const val PLAYLIST_URI = "spotify:playlist:4gPYbdtwW7dtmWIASIths1"
        const val PODCAST_URI = "spotify:show:2emUOZDAW26UviaURdmuQ8"
    }
